...
class favoritesViewController: UITableViewController, SlideMenuDelegate {
    ...
    func getLikes(){
        ...
        Alamofire.request("\(appDel.url)/favorites/\(self.appDel.user)", method: .get).responseJSON { response in
